...
class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    appMinimumVersionAndroid =
        json['app_minimum_version_android']?.toString() ?? '0.0';
    appUrlAndroid = json['app_url_android'];
    appMinimumVersionIos = json['app_minimum_version_ios']?.toString() ?? '0.0';
    ...
    // writeApiKey = json['write_api_key'];
    // readApiKey = json['read_api_key'];
  }
  String? businessName;
  String? logoFullUrl;
  String? address;
