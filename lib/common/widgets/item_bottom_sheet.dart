...
import 'package:friday_sa/common/widgets/quantity_button.dart';
  ...
  void initState() {
    ...
    if (Get.find<SplashController>().module == null) {
      if (Get.find<SplashController>().cacheModule != null) {
        Get.find<SplashController>().setCacheConfigModule(
          Get.find<SplashController>().cacheModule,
        );
      }
    }
    _newVariation =
    ...
    return Container(
      ...
      child: GetBuilder<ItemController>(
        builder: (itemController) {
          ...
          num? discount = (widget.isCampaign || widget.item!.storeDiscount == 0)
              ? widget.item!.discount
              : widget.item!.storeDiscount;
          String? discountType =
              (widget.isCampaign || widget.item!.storeDiscount == 0)
          ...
          num priceWithDiscount = PriceConverter.convertWithDiscount(
            price,
            discount,
            discountType,
          )!;
          ...
          num? priceWithDiscountAndAddons = priceWithDiscount + addonsCost;
                              ...
                              children: [
                                Builder(
                                  builder: (context) {
                                    ...
                                    num withAddonCost = cost! + addonsCost;
                                    return Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceBetween,
                                      children: [
                      ...
                      itemBuilder: (context, i) {
                        if (i == 4 && itemController.collapseVariation[index]) {
                          return Padding(
                            ...
                            child: InkWell(
                              onTap: () =>
                                  itemController.showMoreSpecificSection(index),
                              child: Row(
                                children: [
                                  Icon(
                                    Icons.expand_more,
