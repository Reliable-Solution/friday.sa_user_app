                ...
                ClipRRect(
                  ...
                  child: GoogleMap(
                    ...
                    onMapCreated: (GoogleMapController controller) {
                      ...
                      _isLoading = false;
                      setMarker(
                        widget.track!.orderType == 'parcel'
                            ? Store(
                                latitude:
                                    widget.track!.receiverDetails!.latitude,
                                longitude:
                                    widget.track!.receiverDetails!.longitude,
                                address: widget.track!.receiverDetails!.address,
                                name: widget
                                    .track!
                                    .receiverDetails!
                                    .contactPersonName,
