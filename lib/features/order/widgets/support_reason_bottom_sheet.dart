...
class SupportReasonBottomSheet extends StatefulWidget {
  ...
  @override
  State<SupportReasonBottomSheet> createState() =>
      _SupportReasonBottomSheetState();
}
                    ...
                    Flexible(
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            orderController.supportReasons != null
                            ...
                            !widget.fromChatPage
                                ? CustomTextField(
                                    ...
                                    titleText:
                                        'type_here_to_write_a_custom_message'
                                            .tr,
                                    showLabelText: false,
                                    maxLines: 3,
                        ...
                        ? SafeArea(
                            child: Padding(
                              ...
                              child: CustomButton(
                                ...
                                onPressed:
                                    (selectIndex != -1 || isTextFieldNotEmpty)
                                    ? () async {
                                        Get.back();
                                            ...
                                            orderChatModel: OrderChatModel(
                                              ...
                                              reason:
                                                  (orderController
                                                      ...
                                                      selectIndex != -1)
                                                  ? orderController
                                                        .supportReasons![selectIndex]
                                                  : '',
                                              customMessage:
                                                  massageTextController.text
                                                      .trim(),
                                            ),
                                          ),
                                        );
