...
import 'package:friday_sa/features/order/domain/models/order_cancellation_body.dart';
...
class OrderService implements OrderServiceInterface {
  ...
  Future<void> submitRefundRequest(
    ...
    if (selectedReasonIndex == 0) {
      ...
      Response response = await orderRepositoryInterface.submitRefundRequest(
        body,
        refundImage,
      );
  ...
  Future<bool> switchToCOD(String? orderID, {String? guestId}) async {
    ...
    Response response = await orderRepositoryInterface.switchToCOD(
      orderID,
      guestId: guestId,
    );
    if (response.statusCode == 200) {
