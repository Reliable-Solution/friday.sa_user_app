...
import 'package:friday_sa/features/order/widgets/guest_custom_stepper_widget.dart';
import 'package:friday_sa/features/order/widgets/traking_map_widget.dart';
...
class _GuestTrackOrderScreenState extends State<GuestTrackOrderScreen> {
  ...
  Widget build(BuildContext context) {
    final num width = MediaQuery.sizeOf(context).width;
