...
import 'package:friday_sa/features/checkout/widgets/payment_button_new.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: GetBuilder<CheckoutController>(
                    builder: (checkoutController) {
                      "widget.isDigitalPaymentActive == ${widget.isDigitalPaymentActive}"
                          .print;
                      return Column(
            ...
            SafeArea(
              child: CustomButton(buttonText: 'select'.tr, onPressed: Get.back),
            ),
          ],
        ),
      ),
