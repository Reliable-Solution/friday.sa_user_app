...
import 'package:friday_sa/features/checkout/widgets/prescription_view_dialog_widget.dart';
...
class PrescriptionImagePickerWidget extends StatelessWidget {
  const PrescriptionImagePickerWidget({
    super.key,
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    XFile? file =
                        index == checkoutController.pickedPrescriptions.length
                        ? null
                        : checkoutController.pickedPrescriptions[index];
                    if (index < 5 &&
                        index ==
                            checkoutController.pickedPrescriptions.length) {
                      return InkWell(
                        onTap: () {
              ...
              isPrescriptionRequired
                  ? Container(
                      ...
                      child: Text(
                        'prescription_required_for_this_order_because_you_have_a_item_that_need_prescription'
                            .tr,
