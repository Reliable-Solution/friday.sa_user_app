...
import 'package:friday_sa/features/checkout/widgets/order_successfull_dialog.dart';
import 'package:friday_sa/features/checkout/widgets/partial_pay_dialog_widget.dart';
    ...
    try {
      if (response.statusCode == 200 && response.body['status'] == 'OK') {
        if (isDuration) {
          ...
          num parsedDuration = parseDuration(duration);
          _distance = parsedDuration / 3600;
        } else {
          final num distanceMater = response.body['distanceMeters'] as num;
