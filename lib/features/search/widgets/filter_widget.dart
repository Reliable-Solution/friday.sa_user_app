                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(
                              color:
                                  (isStore
                                      ? searchController.storeSortIndex == index
                  ...
                  isStore
                      ...
                      : Column(
                          children: [
                            ...
                            RangeSlider(
                              values: RangeValues(
                                searchController.lowerValue.toDouble(),
                                searchController.upperValue.toDouble(),
                              ),
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () => isStore
                              ? searchController.setStoreRating(index + 1)
                              : searchController.setRating(index + 1),
                          child: Icon(
                            (isStore
                                    ? searchController.storeRating < (index + 1)
