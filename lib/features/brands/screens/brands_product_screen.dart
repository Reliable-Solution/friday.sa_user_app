    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        if (Get.find<BrandsController>().offset < pageSize) {
          ...
          Get.find<BrandsController>().getBrandItemList(
            widget.brandId,
            Get.find<BrandsController>().offset + 1,
            true,
          );
        }
      }
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    child: brandsController.brandItems != null
                        ? brandsController.brandItems!.isNotEmpty
                              ? ItemsView(
                                  isStore: false,
                                  items: brandsController.brandItems,
                                  stores: null,
