...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  Future<void> splitPhoneNumber(String number) async {
    try {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      CustomTextField(
                                        ...
                                        focusNode: _addressNode,
                                        nextFocus: _nameNode,
                                        onChanged: (text) => locationController
                                            .setPlaceMark(text),
                                      ),
                                      const SizedBox(
                                        height:
  ...
  Future<void> _onSaveOrUpdateButtonPressed(
  ...
  AddressModel? _prepareAddressModel(
    ...
    if (locationController.addressTypeIndex == 2) {
      addressType = _levelController.text.isNotEmpty
          ...
          : locationController.addressTypeList[locationController
                .addressTypeIndex];
    }
