...
import 'package:friday_sa/features/review/widgets/rating_widget.dart';
import 'package:friday_sa/features/review/widgets/review_list_widget.dart';
        ...
        builder: (reviewController) {
          return reviewController.storeReviewList != null
              ? reviewController.storeReviewList!.isNotEmpty
                    ? RefreshIndicator(
                        onRefresh: () async {
                          await reviewController.getStoreReviewList(
                            widget.storeID,
                          );
                        },
                            ...
                            child: Column(
                              children: [
                                WebScreenTitleWidget(
                                  title: widget.storeName ?? 'store_reviews'.tr,
                                ),
                                Center(
                                  child: SizedBox(
