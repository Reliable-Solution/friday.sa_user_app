...
import 'package:friday_sa/features/verification/domain/models/verification_data_model.dart';
...
class VerificationService implements VerificationServiceInterface {
  ...
  Future<ResponseModel> forgetPassword({String? phone, String? email}) async {
    return verificationRepoInterface.forgetPassword(phone: phone, email: email);
  }
  ...
  Future<ResponseModel> resetPassword({
    ...
    return verificationRepoInterface.resetPassword(
  ...
  Future<ResponseModel> verifyToken({
    ...
    return verificationRepoInterface.verifyToken(
      phone: phone,
      email: email,
      token: token,
    );
  ...
  Future<ResponseModel> verifyFirebaseOtp({
    ...
    if (isForgetPassPage) {
      responseModel = await verificationRepoInterface
          .verifyForgetPassFirebaseOtp(
