...
import 'package:friday_sa/features/auth/widgets/sign_in/existing_user_bottom_sheet.dart';
                    ...
                    return Column(
                      children: [
                        ...
                        Get.find<SplashController>().configModel!.demo!
                            ? Text('for_demo_purpose'.tr, style: robotoMedium)
                            : SizedBox(
                                width: 250,
                                child: Wrap(
