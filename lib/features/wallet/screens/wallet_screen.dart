...
import 'package:friday_sa/features/wallet/widgets/bonus_banner_widget.dart';
...
import 'package:friday_sa/features/wallet/widgets/wallet_card_widget.dart';
import 'package:friday_sa/features/wallet/widgets/wallet_history_widget.dart';
import 'package:friday_sa/features/wallet/widgets/web_bonus_banner_widget.dart';
    ...
    if (AuthHelper.isLoggedIn()) {
      ...
      scrollController.addListener(() {
        if (scrollController.position.pixels ==
          ...
          int pageSize = (Get.find<WalletController>().popularPageSize! / 10)
              .ceil();
