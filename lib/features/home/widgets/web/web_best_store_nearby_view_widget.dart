...
import 'package:friday_sa/common/widgets/hover/text_hover.dart';
...
import 'package:friday_sa/features/home/widgets/web/widgets/arrow_icon_button.dart';
...
import 'package:friday_sa/common/widgets/add_favourite_view.dart';
import 'package:friday_sa/common/widgets/card_design/store_card.dart';
import 'package:friday_sa/common/widgets/custom_image.dart';
import 'package:friday_sa/common/widgets/discount_tag.dart';
                  ...
                  ? Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(
                          isPharmacy ? 0 : Dimensions.radiusSmall,
                        ),
                      ),
                      child: Column(
                        children: [
                                    ...
                                    Expanded(
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          num
                                          distance = Get.find<StoreController>()
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child: Stack(
                                                                              children: [
                                                                                ...
                                                                                DiscountTag(
                                                                                  discount: storeController.getDiscount(
                                                                                    storeList[index],
                                                                                  ),
                                                                                  discountType: storeController.getDiscountType(
                                                                                    storeList[index],
                                                                                  ),
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Row(
                                                                                  children: [
                                                                                    ...
                                                                                    Text(
                                                                                      storeList[index].avgRating!.toStringAsFixed(
                                                                                        1,
                                                                                      ),
                                                                                      style: robotoRegular.copyWith(
                                                                                        fontSize: Dimensions.fontSizeSmall,
                                                                                    ...
                                                                                    Text(
                                                                                      "(${storeList[index].ratingCount.toString()})",
                                                                                      style: robotoRegular.copyWith(
                                                                                        fontSize: Dimensions.fontSizeSmall,
                                                                                        color: Theme.of(
                                                                                          context,
