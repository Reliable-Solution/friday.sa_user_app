...
import 'package:friday_sa/features/item/domain/models/basic_medicine_model.dart';
...
import 'package:friday_sa/features/home/widgets/web/widgets/medicine_item_card.dart';
...
class WebBasicMedicineNearbyViewWidget extends StatefulWidget {
  ...
  @override
  State<WebBasicMedicineNearbyViewWidget> createState() =>
      _WebBasicMedicineNearbyViewWidgetState();
}

class _WebBasicMedicineNearbyViewWidgetState
    extends State<WebBasicMedicineNearbyViewWidget> {
        ...
        if (itemController.basicMedicineModel != null) {
          ...
          for (var product in itemController.basicMedicineModel!.products!) {
            ...
            if (product.categoryIds!.any(
              (category) => category.id == categories[selectedCategory].id,
            )) {
              products.add(product);
            }
          }
                    ...
                    children: [
                      Container(
                        ...
                        child: SizedBox(
                          height: 280,
                          width: Get.width,
                          child: itemController.basicMedicineModel != null
                              ? ListView.builder(
          ...
          return Padding(
            ...
            child: Shimmer(
              ...
              child: Container(
                ...
                height: ResponsiveHelper.isDesktop(context) ? 250 : 220,
                decoration: BoxDecoration(
                  color: Theme.of(context).cardColor,
