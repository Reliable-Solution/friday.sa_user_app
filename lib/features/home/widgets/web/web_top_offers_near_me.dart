...
class _WebTopOffersNearMeState extends State<WebTopOffersNearMe> {
  ...
  Widget topOfferCard(Store store, bool isFood, bool isPharmacy) {
    num distance = Get.find<StoreController>().getRestaurantDistance(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (isPharmacy) distanceWidget(distance),
                                  ],
                                ),
                              ),
                            ],
  ...
  Widget distanceWidget(num distance) {
    return Container(
      padding: const EdgeInsets.symmetric(
        horizontal: Dimensions.paddingSizeSmall,
        vertical: 3,
