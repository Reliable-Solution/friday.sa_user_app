                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'see_our_most_popular_store_and_item'.tr,
      ...
      if (videoPlayerController.value.duration ==
        ...
        if (GetPlatform.isWeb) {
          Future.delayed(const Duration(seconds: 4), () {
            Get.find<AdvertisementController>().updateAutoPlayStatus(
              status: true,
              shouldUpdate: true,
            );
          });
