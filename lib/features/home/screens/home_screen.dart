...
import 'package:friday_sa/features/home/widgets/cashback_logo_widget.dart';
import 'package:friday_sa/features/home/widgets/cashback_dialog_widget.dart';
import 'package:friday_sa/features/home/widgets/refer_bottom_sheet_widget.dart';
...
import 'package:friday_sa/features/home/screens/modules/food_home_screen.dart';
import 'package:friday_sa/features/home/screens/modules/grocery_home_screen.dart';
import 'package:friday_sa/features/home/screens/modules/pharmacy_home_screen.dart';
import 'package:friday_sa/features/home/screens/modules/shop_home_screen.dart';
...
import 'package:friday_sa/features/rental_module/home/screens/taxi_home_screen.dart';
...
import 'package:friday_sa/features/home/screens/web_new_home_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:friday_sa/features/home/widgets/module_view.dart';
import 'package:friday_sa/features/parcel/screens/parcel_category_screen.dart';

class HomeScreen extends StatefulWidget {
  const HomeScreen({super.key, this.isLoad = false});
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    HomeScreen.loadData(widget.isLoad).then((value) {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SplashController>(
      builder: (splashController) {
        ...
        debugPrint(
          'object bool $isGrocery $isTaxi $isParcel $isPharmacy $isFood $isShop $showMobileModule',
        );
                      ...
                      child: RefreshIndicator(
                        onRefresh: () async {
                          ...
                          if (Get.find<SplashController>().module != null &&
                            ...
                            Get.find<CampaignController>().getBasicCampaignList(
                              true,
                            );
                            ...
                            if (isPharmacy) {
                              Get.find<ItemController>().getBasicMedicine(
                                true,
                                true,
                              );
                              Get.find<ItemController>().getCommonConditions(
                                true,
                              );
                            }
                            if (isShop) {
