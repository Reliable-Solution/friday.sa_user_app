...
import 'package:friday_sa/features/auth/domain/enum/centralize_login_enum.dart';
import 'package:friday_sa/features/auth/screens/new_user_setup_screen.dart';
import 'package:friday_sa/features/auth/widgets/sign_in/manual_login_widget.dart';
import 'package:friday_sa/features/auth/widgets/sign_in/otp_login_widget.dart';
import 'package:friday_sa/features/auth/widgets/social_login_widget.dart';
...
import 'package:friday_sa/features/verification/domain/enum/verification_type_enum.dart';
...
class _SignInViewState extends State<SignInView> {
  ...
  void initState() {
    ...
    _countryDialCode = authController.getUserCountryCode().isNotEmpty
        ...
        : CountryCode.fromCountryCode(
            splashController.configModel!.country!,
          ).dialCode;
  ...
  Future<void> _otpLogin(
    AuthController authController,
    String countryDialCode,
    CentralizeLoginType loginType,
  ) async {
  ...
  Future<void> _processOtpSuccessSetup(
