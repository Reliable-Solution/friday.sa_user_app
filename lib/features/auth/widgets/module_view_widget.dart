  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<StoreRegistrationController>(
      builder: (storeRegController) {
        ...
        if (storeRegController.moduleList != null &&
            storeRegController.moduleList!.isNotEmpty) {
          for (
            int index = 0;
        ...
        return storeRegController.moduleList != null
            ? Stack(
                    ...
                    child: CustomDropdown<int>(
                      onChange: (int? value, int index) {
                        ...
                        Get.find<StoreRegistrationController>().getPackageList(
                          moduleId: storeRegController.moduleList![value!].id,
                        );
                      },
