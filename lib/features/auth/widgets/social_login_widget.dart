...
import 'package:friday_sa/features/auth/domain/models/social_log_in_body.dart';
...
class SocialLoginWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool canGoogleAndFacebookLogin =
    ...
    return canGoogleAndFacebookLogin || canAppleLogin
        ? (googleLoginActive || facebookLoginActive || appleLoginActive)
              ? Column(
                  children: [
  ...
  Future<void> _facebookLogin() async {
    ...
    if (result.status == LoginStatus.success) {
      ...
      Get.find<AuthController>().loginWithSocialMedia(facebookBodyModel).then((
        response,
      ) {
        if (response.isSuccess) {
