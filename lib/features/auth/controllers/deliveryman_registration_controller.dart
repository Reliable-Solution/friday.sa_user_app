...
import 'package:friday_sa/features/auth/domain/models/delivery_man_vehicles_model.dart';
...
class DeliverymanRegistrationController extends GetxController
  ...
  Future<void> getZoneList() async {
    ...
    _zoneIds = null;
    List<ZoneDataModel>? zones = await deliverymanRegistrationServiceInterface
        .getZoneList();
    if (zones != null) {
      _zoneList = [];
  ...
  Future<void> getModules(int? zoneId) async {
    List<ModuleModel>? modules = await deliverymanRegistrationServiceInterface
        .getModules(zoneId);
    if (modules != null) {
      _moduleList = [];
