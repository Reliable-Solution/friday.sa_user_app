...
import 'package:friday_sa/common/widgets/custom_tool_tip_widget.dart';
import 'package:friday_sa/features/auth/widgets/business/base_card_widget.dart';
import 'package:friday_sa/features/auth/widgets/business/web_business_plan_widget.dart';
import 'package:friday_sa/features/auth/widgets/module_view_widget.dart';
import 'package:friday_sa/features/auth/widgets/web_registration_stepper_widget.dart';
import 'package:friday_sa/features/business/widgets/package_card_widget.dart';
...
import 'package:friday_sa/common/models/translation.dart';
...
import 'package:friday_sa/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:friday_sa/features/auth/widgets/pass_view_widget.dart';
import 'package:friday_sa/features/auth/widgets/select_location_view_widget.dart';
import 'package:friday_sa/helper/responsive_helper.dart';
import 'package:friday_sa/helper/validate_check.dart';
          ...
          child: GetBuilder<StoreRegistrationController>(
            builder: (storeRegController) {
              if (storeRegController.storeAddress != null &&
                ...
                _addressController[0].text = storeRegController.storeAddress
                    .toString();
              }
              return Column(
                children: [
                                                              ...
                                                              children: [
                                                                Padding(
                                                                  ...
                                                                  child: ClipRRect(
                                                                    ...
                                                                    child:
                                                                        storeRegController.pickedCover !=
                                                                            null
                                                                        ? GetPlatform.isWeb
                                                                              ? Image.network(
                                                                        ...
                                                                        (
                                                                          ...
                                                                          return PackageCardWidget(
                                                                            canSelect:
                                                                                ...
                                                                                index,
                                                                            packages:
                                                                                storeRegController.packageModel!.packages![index],
                                                                          );
                                                                        },
                              ...
                              child: Column(
                                children: [
                                  CustomTextField(
                                    ...
                                    required: true,
                                    validator: ValidateCheck.ibanValidation,
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                      vertical:
                                  ...
                                  CustomTextField(
                                    ...
                                    onChanged: (value) {
                                      if (value != null && value.isNotEmpty) {
                                        ...
                                        storeRegController.validPassCheck(
                                          value,
                                        );
                                      } else {
                                        if (storeRegController.showPassView) {
                    ...
                    if (storeRegController.storeStatus == 0.1 ||
                      ...
                      if (storeRegController.storeStatus == 0.1 &&
                        ...
                        if (_formKeyFirst!.currentState!.validate()) {
                          ...
                          } else if (storeRegController.selectedZoneIndex ==
                              -1) {
                      ...
                      storeRegController.registerStore(
                        StoreBodyModel(
