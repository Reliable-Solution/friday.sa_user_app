...
import 'package:friday_sa/features/auth/domain/models/delivery_man_body.dart';
import 'package:friday_sa/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:friday_sa/features/auth/widgets/condition_check_box_widget.dart';
import 'package:friday_sa/features/auth/widgets/pass_view_widget.dart';
import 'package:friday_sa/helper/custom_validator.dart';
...
class _DeliveryManRegistrationScreenState
  ...
  void initState() {
    ...
    Get.find<DeliverymanRegistrationController>().dmStatusChange(
      0.4,
      isUpdate: false,
    );
                          ...
                          child: Column(
                            children: [
                              ...
                              LinearProgressIndicator(
                                ...
                                minHeight: 2,
                                value:
                                    deliverymanRegistrationController.dmStatus,
                              ),
                                                    ...
                                                    child:
                                                        ...
                                                        ? Container(
                                                            ...
                                                            child: CustomDropdown<int>(
                                                              ...
                                                              items: zoneList,
                                                              child: Text(
                                                                '${deliverymanRegistrationController.zoneList![0].name}',
                                                              ),
                                                            ),
                                                          )
                                                        : const Center(
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    deliverymanRegistrationController.zoneIds !=
                                            null
                                        ? Container(
                                            decoration: BoxDecoration(
                                              borderRadius:
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  deliverymanRegistrationController
                                                      ...
                                                      ? 'select_zone'.tr
                                                      : deliverymanRegistrationController
                                                            .zoneList![deliverymanRegistrationController
                                                                .selectedZoneIndex!]
                                                            .name
                                                            .toString(),
                                                ),
  ...
  Future<void> _addDeliveryMan(
    DeliverymanRegistrationController deliverymanRegiController,
  ) async {
    String fName = _fNameController.text.trim();
    String lName = _lNameController.text.trim();
    String email = _emailController.text.trim();
            ...
            DeliveryManBody(
              ...
              identityType:
                  deliverymanRegiController
                      .identityTypeList[deliverymanRegiController
                      .identityTypeIndex],
              zoneId: deliverymanRegiController
                  .zoneList![deliverymanRegiController.selectedZoneIndex!]
                  .id
                  .toString(),
              vehicleId: deliverymanRegiController
                  .vehicles![deliverymanRegiController.vehicleIndex!]
                  .id
                  .toString(),
            ),
          );
      ...
      if (fName.isEmpty) {
        ...
        deliverymanRegiController.registerDeliveryMan(
          DeliveryManBody(
            ...
            email: email,
            identityNumber: identityNumber,
            identityType: deliverymanRegiController
                .identityTypeList[deliverymanRegiController.identityTypeIndex],
            earning: deliverymanRegiController.dmTypeIndex == 1 ? '1' : '0',
            zoneId: deliverymanRegiController
                .zoneList![deliverymanRegiController.selectedZoneIndex!]
                .id
