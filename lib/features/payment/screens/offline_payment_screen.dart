      ...
      for (
        ...
        index <
            Get.find<PaymentController>()
                .offlineMethodList![Get.find<PaymentController>()
        ...
        child: GetBuilder<PaymentController>(
          builder: (paymentController) {
            List<MethodInformations>? methodInformation =
                ...
                ? paymentController
                      .offlineMethodList![paymentController
                          .selectedOfflineBankIndex]
                      .methodInformations!
                : [];
                                  ...
                                  SizedBox(
                                    ...
                                    child: PageView.builder(
                                      onPageChanged: (int pageIndex) {
                                        paymentController.selectOfflineBank(
                                          pageIndex,
                                        );
  ...
  Widget completeButton(
    ...
    for (int i = 0; i < methodInformation!.length; i++) {
      if (methodInformation[i].isRequired! &&
          paymentController.informationControllerList[i].text.isEmpty) {
            ...
            : () async {
                ...
                if (complete) {
                  ...
                  if (orderId.isNotEmpty) {
                    ...
                    paymentController.saveOfflineInfo(jsonEncode(data)).then((
                      success,
                    ) {
                      if (success) {
                        Get.offAllNamed(
                ...
                return Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Flexible(
                        child: Text(
                          offlineMethodList[index].methodFields![i].inputData!,
                          style: robotoMedium,
