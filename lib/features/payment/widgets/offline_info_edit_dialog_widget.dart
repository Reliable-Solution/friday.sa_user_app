  ...
  void initState() {
    ...
    for (int i = 0; i < widget.offlinePayment.input!.length; i++) {
      Get.find<PaymentController>().informationControllerList.add(
        TextEditingController(text: widget.offlinePayment.input![i].userData),
      );
              ...
              return SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    ListView.builder(
                      itemCount:
                          paymentController.informationControllerList.length,
                      shrinkWrap: true,
                      ...
                      itemBuilder: (context, i) {
                        return Padding(
                          ...
                          child: CustomTextField(
                            titleText: widget.offlinePayment.input![i].userInput
                                .toString()
                                .replaceAll('_', ' '),
                            controller:
                                paymentController.informationControllerList[i],
                            focusNode:
                                paymentController.informationFocusList[i],
                            nextFocus:
                                i !=
                                    paymentController
