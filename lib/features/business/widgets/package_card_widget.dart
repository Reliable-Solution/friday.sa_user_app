...
import 'package:friday_sa/features/business/widgets/curve_clipper_widget.dart';
import 'package:friday_sa/features/business/widgets/package_widget.dart';
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    PackageWidget(
                      title:
                          '${isRental ? 'max_trip'.tr : 'max_order'.tr} (${packages.maxOrder})',
                      isSelect: canSelect ? true : false,
                    ),
                    PackageWidget(
                      title:
                          '${isRental ? 'max_vehicle'.tr : 'max_product'.tr} (${packages.maxProduct})',
                      isSelect: canSelect ? true : false,
                    ),
                    packages.pos == 1
                        ? PackageWidget(
