...
import 'package:friday_sa/features/business/widgets/payment_cart_widget.dart';
    ...
    return GetBuilder<BusinessController>(
      builder: (businessController) {
        return PopScope(
          ...
          child: Scaffold(
            appBar: isDesktop
                ? CustomAppBar(title: 'vendor_registration'.tr)
                : null,
                    ...
                    ? SizedBox(
                        ...
                        child: Padding(
                          ...
                          child: RegistrationStepperWidget(
                            status: Get.find<BusinessController>()
                                .businessPlanStatus,
                          ),
                        ),
                      )
