...
import 'package:friday_sa/features/loyalty/widgets/loyalty_bottom_sheet_widget.dart';
import 'package:friday_sa/features/loyalty/widgets/loyalty_card_widget.dart';
import 'package:friday_sa/features/loyalty/widgets/loyalty_history_widget.dart';
    ...
    if (AuthHelper.isLoggedIn()) {
      ...
      scrollController.addListener(() {
        if (scrollController.position.pixels ==
          ...
          int pageSize = (Get.find<LoyaltyController>().popularPageSize! / 10)
              .ceil();
          if (Get.find<LoyaltyController>().offset < pageSize) {
            Get.find<LoyaltyController>().setOffset(
              Get.find<LoyaltyController>().offset + 1,
            );
            if (kDebugMode) {
            ...
            Get.find<LoyaltyController>().getLoyaltyTransactionList(
              Get.find<LoyaltyController>().offset.toString(),
              false,
            );
          }
        }
