...
import 'package:friday_sa/features/location/widgets/dynamic_text_color.dart';
...
import 'package:friday_sa/features/location/widgets/web_landing_page_shimmer_widget.dart';
...
import 'package:friday_sa/features/location/widgets/landing_card_widget.dart';
import 'package:friday_sa/features/location/widgets/registration_card_widget.dart';
...
class _WebLandingPageState extends State<WebLandingPage> {
  ...
  void initState() {
    ...
    if (Get.find<SplashController>().moduleList == null) {
      if (kDebugMode) {
        debugPrint('-------call from web landing page------------');
      }
              ...
              return splashController.landingModel == null
                  ...
                  : Column(
                      children: [
                              ...
                              Expanded(
                                child: ClipPath(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CustomImage(
                                      image:
                                          '${splashController.landingModel != null ? splashController.landingModel!.fixedHeaderImageFullUrl : ''}',
                                      height: 270,
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                              ...
                                              if (_address != null &&
                                                ...
                                                if (response.isSuccess) {
                                                  if (!AuthHelper.isGuestLoggedIn() &&
                                                    ...
                                                    Get.find<AuthController>().guestLogin().then((
                                                      response,
                                                    ) {
                                                      if (response.isSuccess) {
                                                        Get.find<
                                      ...
                                      children: [
                                        PageView.builder(
                                          ...
                                          onPageChanged: (int index) =>
                                              splashController.setModuleIndex(
                                                index >=
                                                        splashController
                                                            .moduleList!
                                                            .length
                                                ...
                                                children: List.generate(
                                                  ...
                                                  (index) {
                                                    var modules =
                                                        splashController
                                                            .landingModel
                                                            ?.availableZoneList?[index]
                                                            .modules ??
                                                        [];
                                                    var modulesText = modules
                                                        .join(', ');
                        ...
                        splashController.landingModel?.joinSellerStatus == 1
                        ...
                        splashController.landingModel != null &&
                            ...
                            : const SizedBox(),
                        const SizedBox(height: 40),
                        splashController.landingModel?.joinDeliveryManStatus ==
                                1
                            ? RegistrationCardWidget(
                                isStore: false,
                                splashController: splashController,
