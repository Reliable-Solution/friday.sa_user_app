...
import 'package:friday_sa/common/widgets/custom_ink_well.dart';
...
import 'package:friday_sa/features/home/widgets/components/flash_sale_card_widget.dart';
...
import 'package:friday_sa/features/flash_sale/widgets/timer_widget.dart';
import 'package:friday_sa/features/flash_sale/widgets/flash_sale_timer_view_widget.dart';
      ...
      builder: (flashSaleController) {
        ...
        if (flashSaleController.flashSaleModel != null &&
          ...
          int index =
              ...
              : 0;
          item =
              flashSaleController.flashSaleModel!.activeProducts![index].item;
          stock =
              flashSaleController.flashSaleModel!.activeProducts![index].stock!;
          sold =
              flashSaleController.flashSaleModel!.activeProducts![index].sold!;
                        ...
                        children: [
                          Padding(
                            ...
                            child: FittedBox(
                              child: CustomInkWell(
                                onTap: () => Get.toNamed(
                                  RouteHelper.getFlashSaleDetailsScreen(
                                    flashSaleController
                                        .flashSaleModel!
                                        .activeProducts![0]
                                        .flashSaleId!,
                          ...
                          flashSaleController.flashSaleModel!.activeProducts !=
                                  null
                              ? FlashSaleCard(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Row(
                    children: [
                      TimerWidget(timeCount: 00, timeUnit: 'days'.tr),
                      const SizedBox(width: Dimensions.paddingSizeDefault),
                      TimerWidget(timeCount: 00, timeUnit: 'hours'.tr),
                      const SizedBox(width: Dimensions.paddingSizeDefault),
                      TimerWidget(timeCount: 00, timeUnit: 'mins'.tr),
                      const SizedBox(width: Dimensions.paddingSizeDefault),
                      TimerWidget(timeCount: 00, timeUnit: 'sec'.tr),
                    ],
                  ),
                ],
              ),
