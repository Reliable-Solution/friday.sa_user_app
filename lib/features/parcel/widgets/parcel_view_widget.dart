...
class _ParcelViewWidgetState extends State<ParcelViewWidget> {
        ...
        builder: (addressController) {
          return GetBuilder<ParcelController>(
            builder: (parcelController) {
              List<DropdownItem<int>> senderAddressList =
              ...
              List<DropdownItem<int>> receiverAddressList =
                  _getDropdownAddressList(
                    context: context,
                    addressList: addressController.addressList,
                    isSender: false,
                                    ...
                                    child: CustomDropdown<int>(
                                      onChange: (int? value, int index) async {
                                        if (parcelController.isSender) {
                                          ...
                                          AddressModel
                                          pickupAddress = AddressModel(
                                            id: senderAddress[index].id,
                                            addressType: senderAddress[index]
                                                .addressType,
                                            contactPersonNumber:
                                                senderAddress[index]
                                                    .contactPersonNumber,
                                            contactPersonName:
                                                senderAddress[index]
                                                    .contactPersonName,
                                            address:
                                                senderAddress[index].address,
                                            latitude:
                                                senderAddress[index].latitude,
                                            longitude:
                                                senderAddress[index].longitude,
                                            zoneId: responseModel.isSuccess
                                                ? responseModel.zoneIds[0]
                                                : 0,
                                            zoneIds: responseModel.zoneIds,
                                            method: senderAddress[index].method,
                                            streetNumber: senderAddress[index]
                                                .streetNumber,
                                            house: senderAddress[index].house,
                                            floor: senderAddress[index].floor,
                                          ...
                                          widget.houseController.text =
                                              senderAddress[index].house ?? '';
                                          widget.floorController.text =
                                              senderAddress[index].floor ?? '';
                                          ...
                                          AddressModel a = AddressModel(
                                            id: receiverAddress[index].id,
                                            addressType: receiverAddress[index]
                                                .addressType,
                                            contactPersonNumber:
                                                receiverAddress[index]
                                                    .contactPersonNumber,
                                            contactPersonName:
                                                receiverAddress[index]
                                                    .contactPersonName,
                                            address:
                                                receiverAddress[index].address,
                                            latitude:
                                                receiverAddress[index].latitude,
                                            longitude: receiverAddress[index]
                                                .longitude,
                                            zoneId: responseModel.isSuccess
                                                ? responseModel.zoneIds[0]
                                                : 0,
                                            zoneIds: responseModel.zoneIds,
                                            method:
                                                receiverAddress[index].method,
                                            streetNumber: receiverAddress[index]
                                                .streetNumber,
                                            house: receiverAddress[index].house,
                                            floor: receiverAddress[index].floor,
                                            zoneData: responseModel.zoneData,
                                          );
                                          parcelController
                                          ...
                                          widget.streetController.text =
                                              ...
                                              '';
                                          widget.houseController.text =
                                              receiverAddress[index].house ??
                                              '';
                                          widget.floorController.text =
                                              receiverAddress[index].floor ??
                                              '';
                                        }
                                      },
                                      ...
                                      child: AddressWidget(
                                        address: parcelController.isSender
                                            ? senderAddress[parcelController
                                                  .senderAddressIndex!]
                                            : receiverAddress[parcelController
  ...
  Future<void> _splitPhoneNumber(String number) async {
    try {
      ...
      widget.phoneController.text = phoneNumber.international.substring(
        _addressCountryCode!.length,
      );
    } catch (e) {
