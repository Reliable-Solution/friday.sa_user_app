...
import 'package:friday_sa/features/parcel/widgets/parcel_view_widget.dart';
...
class _ParcelLocationScreenState extends State<ParcelLocationScreen>
  ...
  Future<void> initCall() async {
    ...
    _tabController?.addListener(() {
      Get.find<ParcelController>().setIsPickedUp(
        _tabController!.index == 0,
        false,
      );
      Get.find<ParcelController>().setIsSender(
        _tabController!.index == 0,
        true,
      );
    });
                        ...
                        child: TabBarView(
                          ...
                          children: [
                            ParcelViewWidget(
                              ...
                              countryCode: parcelController.senderCountryCode,
                            ...
                            ParcelViewWidget(
                              ...
                              countryCode: parcelController.receiverCountryCode,
