...
import 'package:friday_sa/features/checkout/widgets/condition_check_box.dart';
import 'package:friday_sa/features/payment/widgets/offline_payment_button.dart';
import 'package:friday_sa/features/checkout/widgets/payment_button.dart';
import 'package:friday_sa/features/checkout/widgets/tips_widget.dart';
import 'package:friday_sa/features/parcel/widgets/card_widget.dart';
import 'package:friday_sa/features/parcel/widgets/delivery_instruction_bottom_sheet_widget.dart';
import 'package:friday_sa/features/parcel/widgets/details_widget.dart';
...
class _ParcelRequestScreenState extends State<ParcelRequestScreen> {
          ...
          ? () {
              if (parcelController.distance == -1) {
                ...
                PlaceOrderBodyModel placeOrderBody = PlaceOrderBodyModel(
                  ...
                  createNewUser: Get.find<CheckoutController>().isCreateAccount
                      ? 1
                      : 0,
  ...
  num _calculateParcelDeliveryCharge({
