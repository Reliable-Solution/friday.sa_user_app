...
import 'package:friday_sa/features/language/widgets/language_bottom_sheet_widget.dart';
...
import 'package:friday_sa/features/menu/widgets/portion_widget.dart';
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  if (AuthHelper.isLoggedIn())
                                    PortionWidget(
                                      icon: Images.controller,
                                      title: "controllers".tr,
                                      route:
                                          RouteHelper.getControllerListingRoute(),
                                    ),
                                  PortionWidget(
