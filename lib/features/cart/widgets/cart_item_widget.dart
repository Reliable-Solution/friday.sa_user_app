...
class CartItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    num? startingPrice = _calculatePriceWithVariation(item: cart.item);
    num? endingPrice = _calculatePriceWithVariation(
      item: cart.item,
  ...
  num? _calculatePriceWithVariation({
    required Item? item,
    bool isStartingPrice = true,
  }) {
    num? startingPrice;
    num? endingPrice;
    bool newVariation =
