                            ...
                            SizedBox(
                              ...
                              child: PageView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  bool hasSecond =
                                      index2 < suggestedItems!.length;
                                  bool hasThird =
                                      index3 < suggestedItems.length;
                                  bool hasFourth =
                                      index4 < suggestedItems.length;
                                  return Stack(
                                    children: [
                                      Row(
                                        children: [
