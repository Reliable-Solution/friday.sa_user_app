...
import 'package:friday_sa/features/chat/widgets/image_preview_widget.dart';
...
class _ImageFileViewWidgetState extends State<ImageFileViewWidget> {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemCount: widget.currentMessage.fileFullUrl!.length > 3
          ? 4
          : widget.currentMessage.fileFullUrl!.length,
        ...
        return InkWell(
          ...
          child: Stack(
            children: [
              ...
              if ((widget.isRightMessage ? index == 2 : index == 4) &&
                  widget.currentMessage.fileFullUrl!.length > 3 &&
