...
import 'package:friday_sa/features/chat/widgets/chat_serach_field_widget.dart';
...
import 'package:friday_sa/features/chat/widgets/web_chat_view_widget.dart';
  ...
  void initCall() {
    if (AuthHelper.isLoggedIn()) {
      ...
      Get.find<ChatController>().getConversationList(
        1,
        type: ResponsiveHelper.isDesktop(Get.context) ? 'vendor1' : '',
      );
    }
  }
                                                                ...
                                                                >(
                                                                  builder:
                                                                      (
                                                                        ...
                                                                        return (profileController.userInfoModel !=
                                                                                    null &&
                                                                                profileController.userInfoModel!.userInfo !=
                                                                                    null &&
                                                                                conversation!.conversations![index]!.lastMessage!.senderId !=
                                                                                    profileController.userInfoModel!.userInfo!.id &&
