...
import 'package:friday_sa/features/brands/screens/brands_screen.dart';
import 'package:friday_sa/features/business/screens/subscription_payment_screen.dart';
import 'package:friday_sa/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:friday_sa/features/chat/domain/models/order_chat_model.dart';
import 'package:friday_sa/features/controller_screen/controller_listing_screen.dart';
import 'package:friday_sa/features/controller_screen/screens/controller_screen.dart';
import 'package:friday_sa/features/language/screens/country_screen.dart';
import 'package:friday_sa/features/loyalty/screens/loyalty_screen.dart';
import 'package:friday_sa/features/profile/domain/models/update_user_model.dart';
import 'package:friday_sa/features/refer_and_earn/screens/refer_and_earn_screen.dart';
...
import 'package:friday_sa/features/address/screens/add_address_screen.dart';
import 'package:friday_sa/features/address/screens/address_screen.dart';
import 'package:friday_sa/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:friday_sa/features/auth/screens/sign_in_screen.dart';
import 'package:friday_sa/features/auth/screens/sign_up_screen.dart';
import 'package:friday_sa/features/auth/screens/store_registration_screen.dart';
import 'package:friday_sa/features/category/screens/category_screen.dart';
import 'package:friday_sa/features/location/screens/map_screen.dart';
import 'package:friday_sa/features/store/screens/campaign_screen.dart';
...
import 'package:friday_sa/common/widgets/image_viewer_screen.dart';
import 'package:friday_sa/common/widgets/not_found.dart';
import 'package:friday_sa/features/cart/screens/cart_screen.dart';
import 'package:friday_sa/features/category/screens/category_item_screen.dart';
import 'package:friday_sa/features/chat/screens/chat_screen.dart';
import 'package:friday_sa/features/chat/screens/conversation_screen.dart';
import 'package:friday_sa/features/checkout/screens/checkout_screen.dart';
import 'package:friday_sa/features/payment/screens/offline_payment_screen.dart';
import 'package:friday_sa/features/checkout/screens/order_successful_screen.dart';
import 'package:friday_sa/features/payment/screens/payment_screen.dart';
import 'package:friday_sa/features/payment/screens/payment_webview_screen.dart';
import 'package:friday_sa/features/coupon/screens/coupon_screen.dart';
import 'package:friday_sa/features/dashboard/screens/dashboard_screen.dart';
import 'package:friday_sa/features/favourite/screens/favourite_screen.dart';
import 'package:friday_sa/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:friday_sa/features/item/screens/item_campaign_screen.dart';
import 'package:friday_sa/features/item/screens/item_details_screen.dart';
import 'package:friday_sa/features/item/screens/popular_item_screen.dart';
import 'package:friday_sa/features/verification/screens/forget_pass_screen.dart';
import 'package:friday_sa/features/verification/screens/new_pass_screen.dart';
import 'package:friday_sa/features/verification/screens/verification_screen.dart';
import 'package:friday_sa/features/html/screens/html_viewer_screen.dart';
import 'package:friday_sa/features/interest/screens/interest_screen.dart';
import 'package:friday_sa/features/language/screens/language_screen.dart';
import 'package:friday_sa/features/location/screens/access_location_screen.dart';
import 'package:friday_sa/features/location/screens/pick_map_screen.dart';
import 'package:friday_sa/features/notification/screens/notification_screen.dart';
import 'package:friday_sa/features/onboard/screens/onboarding_screen.dart';
import 'package:friday_sa/features/order/screens/guest_track_order_screen.dart';
import 'package:friday_sa/features/order/screens/order_details_screen.dart';
import 'package:friday_sa/features/order/screens/order_screen.dart';
import 'package:friday_sa/features/order/screens/order_tracking_screen.dart';
import 'package:friday_sa/features/order/screens/refund_request_screen.dart';
import 'package:friday_sa/features/parcel/screens/parcel_category_screen.dart';
import 'package:friday_sa/features/parcel/screens/parcel_location_screen.dart';
import 'package:friday_sa/features/parcel/screens/parcel_request_screen.dart';
import 'package:friday_sa/features/profile/screens/profile_screen.dart';
import 'package:friday_sa/features/profile/screens/update_profile_screen.dart';
import 'package:friday_sa/features/store/screens/all_store_screen.dart';
import 'package:friday_sa/features/store/screens/store_item_search_screen.dart';
import 'package:friday_sa/features/store/screens/store_screen.dart';
import 'package:friday_sa/features/review/screens/review_screen.dart';
import 'package:friday_sa/features/search/screens/search_screen.dart';
import 'package:friday_sa/features/splash/screens/splash_screen.dart';
import 'package:friday_sa/features/support/screens/support_screen.dart';
import 'package:friday_sa/features/update/screens/update_screen.dart';
...
class RouteHelper {
  ...
  static const String controllerListing = '/controller-listing';
  ...
  // static const String uploadDocScreen = '/upload-doc-screen';
  ...
  static String getInitialRoute({
    ...
    bool isLoad = false,
  }) => '$initial?from-splash=$fromSplash&isLoad=$isLoad';
  ...
  static String getControllerRoute({
    required String channelId,
    required String readKey,
    required String writeKey,
  }) => "$controller?channelId=$channelId&readKey=$readKey&writeKey=$writeKey";
  static String getControllerListingRoute() => controllerListing;

  static String getLanguageRoute(String page) => '$language?page=$page';

  static String getCountryRoute(String page, {bool isFromLogin = false}) =>
      '$country?page=$page&fromLogin=$isFromLogin';

  static String getOnBoardingRoute() => onBoarding;

  static String getSignInRoute(String page, {bool fromCountry = false}) =>
      '$signIn?page=$page&fromCountry=$fromCountry';
  ...
  static String getOrderDetailsRoute(
    int? orderID, {
  ...
  static String getEditAddressRoute(
  ...
  static String getParcelRequestRoute(
    ParcelCategoryModel category,
    AddressModel pickupAddress,
    AddressModel destinationAddress,
  ) {
    String category0 = base64Url.encode(
      utf8.encode(jsonEncode(category.toJson())),
    );
    String pickedUpAddress = base64Url.encode(
      utf8.encode(jsonEncode(pickupAddress.toJson())),
    );
    String destinationAddress0 = base64Url.encode(
      utf8.encode(jsonEncode(destinationAddress.toJson())),
    );
  ...
  static String getChatRoute({
    ...
    if (notificationBody != null) {
      notificationBody0 = base64Encode(
        utf8.encode(jsonEncode(notificationBody.toJson())),
      );
    }
    String orderChat = 'null';
    if (orderChatModel != null) {
      orderChat = base64Encode(
        utf8.encode(jsonEncode(orderChatModel.toJson())),
      );
    }
    String user0 = 'null';
    if (user != null) {
  ...
  static String getOfflinePaymentScreen({
    ...
    required int? zoneId,
    required num total,
    required num? maxCodOrderAmount,
  ...
  static List<GetPage> routes = [
    GetPage(
      ...
      page: () => getRoute(
        DashboardScreen(
          ...
          isLoad: Get.parameters['isLoad'] == 'true',
        ),
      ),
    ),
    GetPage(
    ...
    GetPage(
      ...
      page: () => CountryScreen(
        ...
        fromLogin: Get.parameters['fromLogin'] == 'true',
      ),
    ),
    ...
    GetPage(
      ...
      page: () => SignInScreen(
        ...
        fromCountry: Get.parameters['fromCountry'] == 'true',
      ),
    ),
    ...
    GetPage(
      ...
      page: () {
        ...
        if (Get.parameters['session'] != null &&
          ...
          session = utf8.decode(
            base64Url.decode(Get.parameters['session'] ?? ''),
          );
        }
        ...
        return VerificationScreen(
          ...
          password: pass,
          email:
              Get.parameters['email'] != '' && Get.parameters['email'] != 'null'
    ...
    GetPage(
      ...
      page: () => ControllerScreen(
        channelId: Get.parameters['channelId'] as String,
        readKey: Get.parameters['readKey'] as String,
        writeKey: Get.parameters['writeKey'] as String,
      ),
    ),
    GetPage(
      name: controllerListing,
      page: () => const ControllerListingScreen(),
    ),
    GetPage(
      name: accessLocation,
    ...
    GetPage(
      ...
      page: () {
        ...
        return ((Get.parameters['page'] == 'parcel' && pickMapScreen == null) ||
    ...
    // GetPage(
    //     name: uploadDocScreen, page: () => getRoute(const UploadDocScreen())),
    GetPage(
      name: notification,
      page: () => getRoute(
        NotificationScreen(fromNotification: Get.parameters['from'] == 'true'),
      ),
    ),
    GetPage(
      name: map,
      page: () {
        ...
        AddressModel data = AddressModel.fromJson(
          jsonDecode(utf8.decode(decode)),
        );
        return getRoute(
          MapScreen(
    ...
    GetPage(
      name: basicCampaign,
      page: () {
        BasicCampaignModel data = BasicCampaignModel.fromJson(
          jsonDecode(
            utf8.decode(
      ...
      page: () => getRoute(
        ReviewScreen(
          ...
          store: Store.fromJson(
            jsonDecode(
              utf8.decode(
                base64Url.decode(Get.parameters['store']!.replaceAll(' ', '+')),
              ),
            ),
          ),
        ),
      ...
      page: () => getRoute(
        ImageViewerScreen(
          item: Item.fromJson(
            jsonDecode(
              utf8.decode(
                base64Url.decode(Get.parameters['item']!.replaceAll(' ', '+')),
              ),
            ),
          ),
        ),
    ...
    GetPage(
      ...
      page: () => getRoute(
        ParcelLocationScreen(
          category: ParcelCategoryModel.fromJson(
            jsonDecode(
              utf8.decode(
                base64Url.decode(Get.parameters['data']!.replaceAll(' ', '+')),
              ),
    ...
    GetPage(
      ...
      page: () => getRoute(
        ParcelRequestScreen(
          parcelCategory: ParcelCategoryModel.fromJson(
            jsonDecode(
              utf8.decode(
                base64Url.decode(
          ...
          pickedUpAddress: AddressModel.fromJson(
            jsonDecode(
              utf8.decode(
                base64Url.decode(
          ...
          destinationAddress: AddressModel.fromJson(
            jsonDecode(
              utf8.decode(
                base64Url.decode(
    ...
    GetPage(
      ...
      page: () {
        ...
        if (Get.parameters['order-chat'] != 'null') {
          orderChat = OrderChatModel.fromJson(
            jsonDecode(
              utf8.decode(
                base64Url.decode(
    ...
    GetPage(
      ...
      page: () {
        List<int> decode = base64Decode(
          Get.parameters['order_body']!.replaceAll(' ', '+'),
        );
        PlaceOrderBodyModel orderBody = PlaceOrderBodyModel.fromJson(
          jsonDecode(utf8.decode(decode)),
        );
        ...
        return OfflinePaymentScreen(
          ...
          zoneId: int.parse(Get.parameters['zone_id']!),
          total: num.parse(Get.parameters['total']!),
          maxCodOrderAmount:
              (Get.parameters['max_cod_amount'] != null &&
                  Get.parameters['max_cod_amount'] != 'null')
              ? num.parse(Get.parameters['max_cod_amount']!)
              : null,
    ...
    GetPage(
      ...
      page: () => NewUserSetupScreen(
        ...
        loginType: Get.parameters['login_type']!,
        phone:
            Get.parameters['phone'] != '' && Get.parameters['phone'] != 'null'
