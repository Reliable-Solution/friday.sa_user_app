...
import 'package:friday_sa/common/widgets/demo_reset_dialog_widget.dart';
import 'package:friday_sa/common/widgets/taxi_make_payment_bottomsheet.dart';
...
import 'package:friday_sa/features/rental_module/rental_order/screens/taxi_order_details_screen.dart';
...
import 'package:friday_sa/features/notification/widgets/notifiation_popup_dialog_widget.dart';
        ...
        try {
          if (load.payload!.isNotEmpty) {
            ...
            final Map<NotificationType, Function> notificationActions = {
              ...
              NotificationType.add_fund: () => Get.toNamed(
                RouteHelper.getWalletRoute(fromNotification: true),
              ),
              NotificationType.referral_earn: () => Get.toNamed(
                RouteHelper.getWalletRoute(fromNotification: true),
              ),
              NotificationType.cashback: () => Get.toNamed(
                RouteHelper.getWalletRoute(fromNotification: true),
              ),
